...
namespace renderer {
    ...
    {
        _getcwd( mszTempPath, MAX_PATH );
        _chdir( mstrBasePath.c_str() );
    }
    ...
    void FileSystem::load() {
        ...
        */
        ...
        be a directory */
        char szCurrPath[260];
        _getcwd( szCurrPath, 259 );
        if( _chdir( mName.c_str() ) )
