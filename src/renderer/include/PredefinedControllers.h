...
*/
class _RendererExport TextureFrameControllerValue : public ControllerValue {
protected:
...
*/
class _RendererExport TexCoordModifierControllerValue : public ControllerValue {
protected:
...
*/
class _RendererExport AnimationControllerFunction : public ControllerFunction {
protected:
  Real mSeqTime;
  Real mTime;
public:
...
*/
class _RendererExport ScaleControllerFunction : public ControllerFunction {
protected:
  Real mScale;
public:
...
*/
class _RendererExport WaveformControllerFunction : public ControllerFunction {
protected:
