...
/** Manages the rendering of a 'scene' i.e. a collection of primitives.
    ...
    @version
        1.0
 */
class _RendererExport SceneManager
{
...
public:
    ...
    */
    struct materialLess
    {
        _RendererExport bool operator()(const Material* x, const Material* y) const;
    };
...
class _RendererExport DefaultIntersectionSceneQuery : 
...
class _RendererExport DefaultRaySceneQuery : public RaySceneQuery
{
public:
...
class _RendererExport DefaultSphereSceneQuery : public SphereSceneQuery
{
public:
...
class _RendererExport DefaultAxisAlignedBoxSceneQuery : public AxisAlignedBoxSceneQuery
{
public:
