...
#define Except( num, desc, src ) throw( renderer::Exception( num, desc, src, __FILE__, __LINE__ ) )
...
#       define OgreGuard( a ) renderer::AutomaticGuardUnguard _auto_guard_object( (a) )
#   else
#       define OgreGuard( a ) renderer::AutomaticGuardUnguard _auto_guard_object( __FUNC__ )
#   endif
...
#           define OgreAssert( a, b ) if( !(a) ) Except( renderer::Exception::ERR_RT_ASSERTION_FAILED, (b), "no function info" )
#       else
#           define OgreAssert( a, b ) if( !(a) ) Except( renderer::Exception::ERR_RT_ASSERTION_FAILED, (b), __FUNC__ )
#       endif
...
/** When thrown, provides information about an error that has occurred inside the engine.
    ...
    @par
        ...
        same object.
*/
class _RendererExport Exception {
protected:
  long line;
  int number;
  String description;
...
class _RendererExport AutomaticGuardUnguard {
public:
