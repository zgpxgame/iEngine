...
Copyright (c)2000-2003 The OGRE Team
...
*/
class _RendererExport SceneQuery {
public:
...
*/
class _RendererExport SceneQueryListener {
public:
...
struct _RendererExport SceneQueryResult {
...
*/
class _RendererExport RegionSceneQuery
...
class _RendererExport AxisAlignedBoxSceneQuery : public RegionSceneQuery {
protected:
...
class _RendererExport SphereSceneQuery : public RegionSceneQuery {
protected:
  Sphere mSphere;
public:
...
class _RendererExport RaySceneQuery : public RegionSceneQuery {
protected:
  Ray mRay;
...
class _RendererExport PyramidSceneQuery : public RegionSceneQuery
{
public:
...
*/
class _RendererExport IntersectionSceneQueryListener {
public:
...
struct _RendererExport IntersectionSceneQueryResult {
...
*/
class _RendererExport IntersectionSceneQuery
