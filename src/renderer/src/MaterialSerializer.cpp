...
void MaterialSerializer::writeTextureLayer(const Material::TextureLayer *pTex) {
  ...
  //addressing mode
  if (mDefaults ||
      pTex->getTextureAddressingMode() != renderer::Material::TextureLayer::TAM_WRAP) {
    writeSubAttribute("tex_address_mode");
    switch (pTex->getTextureAddressingMode()) {
    case renderer::Material::TextureLayer::TAM_CLAMP:
      writeValue("clamp");
      break;
    case renderer::Material::TextureLayer::TAM_MIRROR:
      writeValue("mirror");
      break;
    case renderer::Material::TextureLayer::TAM_WRAP:
      writeValue("wrap");
      break;
    }
  }
